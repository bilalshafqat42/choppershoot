...
const architectureData = [
  {
    ...
    title: "dubai",
    imageUrl:
      "../../../assets/images/arch/dubai/0A0318BC-5C20-47B4-9739-7E0EB00459C1.jpg",
  },
  {
    id: "2",
    title: "Abu Dhabi",
    imageUrl: "../assets/images/arch/dubai/2.jpg",
  },
  {
    id: "3",
    title: "Dubai",
    imageUrl: "../assets/images/arch/dubai/3.jpg",
  },
  {
    id: "4",
...
const getImageSource = (id) => {
  const imageMap = {
    "1": require("../../../assets/images/arch/dubai/1.jpg"),
    "2": require("../../../assets/images/arch/dubai/2.jpg"),
    "3": require("../../../assets/images/arch/dubai/3.jpg"),
    "4": require("../../../assets/images/arch/dubai/4.jpg"),
    "5": require("../../../assets/images/arch/dubai/5.jpg"),
    "6": require("../../../assets/images/arch/dubai/6.jpg"),
    "7": require("../../../assets/images/arch/dubai/7.jpg"),
    "8": require("../../../assets/images/arch/dubai/8.jpg"),
    "9": require("../../../assets/images/arch/dubai/9.jpg"),
    "10": require("../../../assets/images/arch/dubai/10.jpg"),
    "11": require("../../../assets/images/arch/dubai/11.jpg"),
    "12": require("../../../assets/images/arch/dubai/12.jpg"),
    "13": require("../../../assets/images/arch/dubai/13.jpg"),
    "14": require("../../../assets/images/arch/dubai/14.jpg"),
    "15": require("../../../assets/images/arch/dubai/15.jpg"),
    "16": require("../../../assets/images/arch/dubai/16.jpg"),
    "17": require("../../../assets/images/arch/dubai/17.jpg"),
    "18": require("../../../assets/images/arch/dubai/18.jpg"),
    "19": require("../../../assets/images/arch/dubai/19.jpg"),
    "20": require("../../../assets/images/arch/dubai/20.jpg"),
    "21": require("../../../assets/images/arch/dubai/21.jpg"),
    "22": require("../../../assets/images/arch/dubai/22.jpg"),
    "23": require("../../../assets/images/arch/dubai/23.jpg"),
    "24": require("../../../assets/images/arch/dubai/24.jpg"),
    "25": require("../../../assets/images/arch/dubai/25.jpg"),
    "26": require("../../../assets/images/arch/dubai/26.jpg"),
    "27": require("../../../assets/images/arch/dubai/27.jpg"),
    "28": require("../../../assets/images/arch/dubai/28.jpg"),
    "29": require("../../../assets/images/arch/dubai/29.jpg"),
    "30": require("../../../assets/images/arch/dubai/30.jpg"),
    "31": require("../../../assets/images/arch/dubai/31.jpg"),
    "32": require("../../../assets/images/arch/dubai/32.jpg"),
    "33": require("../../../assets/images/arch/dubai/33.jpg"),
    "34": require("../../../assets/images/arch/dubai/34.jpg"),
    "35": require("../../../assets/images/arch/dubai/35.jpg"),
    "36": require("../../../assets/images/arch/dubai/36.jpg"),
    "37": require("../../../assets/images/arch/dubai/37.jpg"),
    "38": require("../../../assets/images/arch/dubai/38.jpg"),
    "39": require("../../../assets/images/arch/dubai/39.jpg"),
    "40": require("../../../assets/images/arch/dubai/40.jpg"),
    "41": require("../../../assets/images/arch/dubai/41.jpg"),
    "42": require("../../../assets/images/arch/dubai/42.jpg"),
    "43": require("../../../assets/images/arch/dubai/43.jpg"),
    "44": require("../../../assets/images/arch/dubai/44.jpg"),
    "45": require("../../../assets/images/arch/dubai/45.jpg"),
    "46": require("../../../assets/images/arch/dubai/46.jpg"),
    "47": require("../../../assets/images/arch/dubai/47.jpg"),
    "48": require("../../../assets/images/arch/dubai/48.jpg"),
    "49": require("../../../assets/images/arch/dubai/49.jpg"),
    "50": require("../../../assets/images/arch/dubai/50.jpg"),
    "51": require("../../../assets/images/arch/dubai/51.jpg"),
    "52": require("../../../assets/images/arch/dubai/52.jpg"),
    "53": require("../../../assets/images/arch/dubai/53.jpg"),
    "54": require("../../../assets/images/arch/dubai/54.jpg"),
    "55": require("../../../assets/images/arch/dubai/55.jpg"),
    // add other image mappings here...
  };
  return imageMap[id] || require("../../../assets/images/arch/dubai/1.jpg");
};

export default function dubaiArchitecture() {
    ...
    <View style={styles.container}>
      <ThemedView style={styles.titleContainer}>
        ...
        <ThemedText style={styles.description}>
          Choppershoot's aerial shoot in Dubai, United Arab Emirates
        </ThemedText>
      </ThemedView>
      <FlatList
